...
- **Dev Server URL**: `http://127.0.0.1:5245`
- **Preview URL**: `https://api.chitterchat.co.uk/chipify/projects/2d24df26-29dc-429d-bb96-31d201b82b6b/preview`
- **Port**: `5245`
...
4. The dev server is accessible at `http://127.0.0.1:5245`
5. Preview the application using the preview URL: `https://api.chitterchat.co.uk/chipify/projects/2d24df26-29dc-429d-bb96-31d201b82b6b/preview`
